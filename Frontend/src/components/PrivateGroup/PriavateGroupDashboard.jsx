...
//     useEffect(() => {
//         // Use the combined fetch function for the initial load
...
//                                 <div
//                                     key={group._id}
//                                     // 🔑 FIX APPLIED HERE: Move onClick handler to the outermost div
...
//                                         {/* Group Info Section (Inner div is just for layout, no click handler here) */}
//                                         <div 
//                                             className="flex items-center mb-1 flex-1 min-w-0 pr-2"
//                                         >
...
//                                             <button
//                                                 onClick={(e) => {
//                                                     e.stopPropagation(); // MUST remain to prevent selection
//                                                     handleDeleteGroup(group._id, group.name);
//                                                 }}
//                                                 className={`text-xs ml-2 p-1 rounded-full transition-colors flex-shrink-0 ${isSelected ? 'bg-purple-800 text-purple-100 hover:bg-red-700' : 'bg-red-50 text-red-600 hover:bg-red-100'}`}
...
//                                             {needsExpansion && (
//                                                 <button
//                                                     onClick={(e) => { e.stopPropagation(); toggleDescription(group._id); }} // MUST remain to prevent selection
