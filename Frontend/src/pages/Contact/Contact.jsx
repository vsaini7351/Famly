  ...
  return (
    <main className="bg-gray-50 text-gray-800 font-sans min-h-screen flex items-center justify-center py-24 px-4">
      ...
      <div className="max-w-6xl w-full lg:grid lg:grid-cols-2 lg:gap-16 lg:items-start">
        ...
        {/* Contact Form */}
        <div>
            <h2 className="text-3xl font-bold text-purple-700 sm:text-4xl mb-6">Send Us a Message</h2>
            <form className="space-y-6 bg-gradient-to-br from-blue-100 via-purple-100 to-yellow-100 p-8 rounded-2xl shadow-lg">
                <div>
        ...
        <div className="mt-12 lg:mt-0">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl mb-6">Contact Info</h2>
            <div className="space-y-6">
                ...
                <p className="text-gray-600">Room no: G105, Patel Hostel, Motilal Nehru National Institute of Technology Allahabad, Prayagraj, Uttar Pradesh, India -211004</p>
                </div>
